...
<html lang="en" class="no-js">
  <head>
    ...
    <meta
      ...
      content="vcard, resume, personal, portfolio, cv, card, responsive"
    />
    <meta name="Vincent" content="" />

    <!--Page Title-->
    <title>Vincent Kiplangat</title>
    ...
    <script
      async
      src="https://www.googletagmanager.com/gtag/js?id=UA-122650090-4"
    ></script>
    <script>
  ...
  <body>
    ...
    <div class="theme-options dark">
      ...
      <div class="theme-menu">
        <div class="theme-color">
          <h4 class="mt-20 mb-10">Theme Colors</h4>
          <ul>
            <li>
              <a href="css/tan-color.css" style="background-color: #f5ae51"></a>
            </li>
            <li>
              <a href="css/red-color.css" style="background-color: #d94c48"></a>
            </li>
            <li>
              <a
            ...
            <li>
              <a
                ...
                style="background-color: #bb68c8"
              ></a>
            </li>
            <li>
              <a href="css/cyan-color.css" style="background-color: cyan"></a>
            </li>
          </ul>
        </div>

        <!--<div class="background-demos">-->
        <!--<h4 class="mt-20 mb-10">Background Demos</h4>-->

        <!--<ul class="demo-links">-->
        <!--<li><a href="index.html">BG Image</a></li>-->
        <!--<li><a href="index-slider.html">BG Slider</a></li>-->
        <!--<li><a href="index-video.html">BG Video</a></li>-->
        <!--<li><a href="index-particles.html">BG Particles</a></li>-->
        <!--</ul>-->
        <!--</div>-->
      </div>
    </div>
    ...
    <header>
      <!-- logo -->
      <a class="logo" href="index-main.html#home"><span>VKK</span></a>
      ...
      <nav class="nav-menu">
        <div class="nav-menu--links">
          <a class="nav-menu--link link--active" href="#home"
            ><i class="fas fa-home"></i><span>Home</span></a
          >
          <a class="nav-menu--link" href="#about"
            ><i class="fas fa-user"></i><span>About</span></a
          >
          <a class="nav-menu--link" href="#resume"
            ><i class="fas fa-address-card"></i><span>Resume</span></a
          >
          <a class="nav-menu--link" href="#portfolio"
            ><i class="fas fa-briefcase"></i><span>Portfolio</span></a
          >
          <a class="nav-menu--link" href="#blog"
            ><i class="fas fa-book"></i><span>Blog</span></a
          >
        ...
        <div class="social-links">
          <a class="social-link" href="index-main.html#">
        ...
        <!-- copyright text -->
        <div class="copy">
          <p>Copyright &copy; 2023 Kenduiwa, All rights Reserved.</p>
        </div>
      </nav>
    </header>
    <!-- Header End -->
    ...
    <div id="main" class="pages-stack">
      ...
      >
        <div class="banner-text">
          ...
          <div class="text-slideshow" data-effect="fx9">
            <div class="text-slide text-slide--current">
              <h2 class="animate-title">Electronic Engineer</h2>
            </div>
            <div class="text-slide text-slide--current">
              <h2 class="animate-title">Computer Engineer</h2>
            </div>
            <div class="text-slide">
              <h2 class="animate-title">Data Scientist</h2>
            </div>
            <div class="text-slide">
              <h2 class="animate-title">Web Developer</h2>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="row about-info mb-60">
            ...
            <div class="col-lg-7">
              ...
              <p>
                Hello! I’m <strong>Brandon Clarks</strong>. Web Developer with
                over 8 years of experience. Experienced with all stages of the
                development cycle for dynamic web projects. Having an in-depth
                knowledge including advanced
                <strong>HTML5, CSS3, JavaScript, jQuery, Angular JS</strong>. I
                ...
                <div class="col-sm-6">
                  ...
                  <ul class="about-list">
                    <li>
                      ...
                      <span class="value">Vincent Kiplangat</span>
                    </li>

                    <li>
                      <span class="title">Email</span>
                      <span class="value">vkorir.143@gmail.com</span>
                    </li>

                    <li>
                      <span class="title">Linkedin</span>
                      <span class="value"><a href="http://www.linkedin.com/in/vincent-kiplangat-9510621bb/">www.vincentkiplangat.com</a></span>
                    </li>
                ...
                <div class="col-sm-6">
                  ...
                  <ul class="about-list">
                    <li>
                      ...
                      <span class="value">+254728552650</span>
                    </li>
                    <li>
                      <span class="title">Address</span>
                      <span class="value">Westlands, Nairobi 00100</span>
                    </li>
                    <li>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <!-- <div class="resume-button">
                    <a class="main-btn" href="index-main.html#">Download CV</a>
                  </div> -->

                  <div class="resume-button">
                    <a class="main-btn" href="download/CV.pdf" download="Vincent Kiplangat CV.pdf">Download CV</a>
                  </div>
          ...
          <div class="row services mb-20">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="service-item">
                ...
                <p>
                  Elit aspernatur provident maxime culpa quo Sed quia doloremque
                  iusto cum quidem? Amet asperiores consequatur
                </p>
              </div>
            </div>
              ...
              <div class="testimonial-item">
                <div class="description">
                  <p>
                    ...
                    Vivamus ipsum augue, lacinia vel arcu condimentum, dictum
                    tristique sem. Nam enim neque, mattis ut fermentum vitae,
                    venenatis id tortor. Sed consectetur tortor ut arcu pharetra
                    faucibus. In tristique sollicitudin mi ac congue. Praesent
                    efficitur feugiat nisl.
                  </p>
                </div>
              ...
              <ul class="experience timeline">
                ...
                <li class="event">
                  ...
                  <p>
                    ...
                    voluptatem Veritatis ipsam neque mollitia vero ipsa.
                  </p>
                </li>
                ...
                <li class="event">
                  ...
                  <p>
                    ...
                    dignissimos debitis expedita asperiores delectus.
                  </p>
                </li>
              </ul>
              ...
              <ul class="education timeline">
                ...
                <li class="event">
                  ...
                  <h5>
                    ...
                    <span class="company"
                      >Royal College Of Art, London, UK</span
                    >
                  </h5>
                  <p>
                    Provident veritatis exercitationem eum doloremque itaque
                    expedita? Ex voluptatem nostrum numquam illum.
                  </p>
                </li>
                ...
                <li class="event">
                  ...
                  <h5>
                    ...
                    <span class="company"
                      >Central Saint Martins, London, UK</span
                    >
                  </h5>
                  <p>
                    Elit voluptatibus quas necessitatibus ullam tenetur
                    provident voluptatibus. Ratione delectus lorem minus ipsa.
                  </p>
                </li>
                ...
                <li class="event">
                  ...
                  <p>
                    Ipsum ex exercitationem est aliquid eos saepe. Dolorum
                    aperiam cupiditate labore vero deleniti Aut unde deser.
                  </p>
                </li>
              </ul>
            ...
            <div class="item col-lg-4 col-sm-6 brand design">
              <figure>
                ...
                <figcaption>
                  ...
                  <p>Brand</p>
                  <i class="fas fa-image"></i>
                  <a class="image-link" href="img/portfolio/img-6.jpg"
                    >View More</a
                  >
                </figcaption>
              </figure>
            ...
            <div class="item col-lg-4 col-sm-6 brand graphic">
              <figure>
                ...
                <figcaption>
                  ...
                  <p>Graphic</p>
                  <i class="fas fa-image"></i>
                  <a class="image-link" href="img/portfolio/img-11.jpg"
                    >View More</a
                  >
                </figcaption>
              </figure>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 contact-detail">
              ...
              <p>
                For more information on any of our services or to talk about how
                we may be able to help you, please get in touch with us using
                the form opposite. Or you can call and follow our social media.
              </p>
              <ul class="contact-info">
                <li class="phone">
                  <span class="title">Phone</span
                  ><span class="value">(+12) 012 456 7890</span>
                </li>
                <li class="address">
                  <span class="title">Address</span
                  ><span class="value">01, Lorem Ipsum Road, NY, USA</span>
                </li>
                <li class="email">
              ...
              <div class="social-media">
                ...
                <div class="social-media-icons">
                  <a href="index-main.html#"><i class="fab fa-facebook"></i></a>
                  <a href="index-main.html#"><i class="fab fa-twitter"></i></a>
                  <a href="index-main.html#"><i class="fab fa-dribbble"></i></a>
                  <a href="index-main.html#"><i class="fab fa-linkedin"></i></a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <form
                id="contact-form"
                method="post"
                action="https://clarks-vcard.netlify.app/mail.php"
              >
                <!--input field-->
                <div class="input">
                  <input
                    class="input-field cf-validate"
                    id="cf-name"
                    type="text"
                    name="name"
          ...
          <div class="row">
            <div class="col-md-12 google-map">
              <!-- Update the data-latitude, data-longitude, and data-zoom attributes with Nairobi's coordinates -->
              <div
                id="map"
                data-latitude="-1.286389"
                data-longitude="36.817223"
                data-zoom="12"
              ></div>
            </div>
          </div>
